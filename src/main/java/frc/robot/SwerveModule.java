...
public class SwerveModule {
  ...
  private final ProfiledPIDController m_turningPIDController =
      new ProfiledPIDController(
          ...
          0.02,
          0,
          new TrapezoidProfile.Contraints(
...
//    m_turningEncoder.setDistancePerPulse(2 * Math.PI / kEncoderResolution);
  ...
  public SwerveModuleState getState() {
    return new SwerveModuleState(m_driveEncoder.getPositionConversionFactor(), new Rotation2d(m_turningEncoder.getAbsolutePosition()));
  }
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    final double driveOutput =
        m_drivePIDController.calculate(m_driveEncoder.getPositionConversionFactor(), state.speedMetersPerSecond);
